...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DDcbm2kS.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CJUaFsya.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Vpq_3Hah.mjs"),
		import("./start-BQsscJ-i.mjs"),
